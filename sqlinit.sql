...
create table level1 (Team varchar(20) not null, Challenge varchar(512) not null, Password varchar(50) not null, primary key(Team));

create table level2 (Team varchar(20) not null, Challenge varchar(512) not null, Password varchar(50) not null, primary key(Team));

create table level3 (Team varchar(20) not null, Challenge varchar(512) not null, Password varchar(50) not null, primary key(Team));
...
insert into level1 values ("b", "Mewa wa mey twsam iepjoys gt mey ipbya. Pa xgn iph ayy, meysy wa hgmewhr gt whmysyam wh mey iepjoys. Agjy gt mey kpmys iepjoysa vwkk oy jgsy whmysyamwhr meph mewa ghy, hg cgly! Mey iguy nayu tgs mewa jyaapry wa p awjfky anoamwmnmwgh iwfeys wh vewie uwrwma epby oyyh aewtmyu ox 8 fkpiya. Mey fpaavgsu wa rwbyh oykgv, vwmegnm mey dngmya.\n\n\nuhXhQ03nfrv", MD5("level1b"));

insert into level2 values ("b", "Lg ccud qh urg tgay ejbwdkt, wmgtf su bgud nkudnk lrd vjfbg. Yrhfm qvd vng sfuuxytj \"vkj_ecwo_ogp_ej_rnfkukf\" wt iq urtuwjm. Ocz iqa jdag vio uzthsivi pqx vkj pgyd encpggt. Uy hopg yjg fhkz arz hkscv ckoq pgfn vu wwygt nkioe zttft djkth.", MD5("level2b"));

insert into level3 values ("b", "qmnjvsa nv wewc flct vprj tj tvvplvl fv xja vqildhc xmlnvc nacyclpa fc gyt vfvw. fv wgqyp, pqq pqcs y wsq rx qmnjvafy cgv tlvhf cw tyl aeuq fv xja tkbv cqnsqs. lhf avawnc cv eas fuqb qvq tc yllrqr xxwa cfy. psdc uqf avrqc gefq pyat trac xwv taa wwd dv eas flcbq. vd trawm vupq quw x decgqcwt, yq yafl vlqs yqkawq! sn fn wgafldw, gmavh qql vfhnprlw\n\n\nxud_ptobo_tm_kmly", MD5("level3b"));

insert into level4 values("b", "1234567890abcdef1234567890abcdef", MD5("level4b"), "9AE0A1E2BCB2E260");

insert into level5 values("b", "1234567890abcdef1234567890abcdef", MD5("level5b"), "84 0 0 0 0 0 0 0;112 70 0 0 0 0 0 0;9 31 43 0 0 0 0 0;102 20 12 12 0 0 0 0;111 60 1 111 112 0 0 0;19 47 120 15 98 11 0 0;12 111 19 105 75 92 27 0;76 3 72 27 13 85 3 38", "1 5 9 54 125 12 49 37");
...
insert into level7 values("b", "12 25 45 68 98 56 25 120 85 10 25 63 25 65 89 54 12 56 58 45 12 55 33 22 45 65 89 45 12 55 66 55 45", MD5("level7b"));
