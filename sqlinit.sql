...
create table level3ques (Team varchar(20) not null, Challenge varchar(350) not null, primary key(Team));
...
insert into level2sol values ("a", MD5("level2"));

insert into level3ques values ("a", "Lg ccud qh urg tgay ejbwdkt, wmgtf su bgud nkudnk lrd vjfbg. Yrhfm qvd vng sfuuxytj \"vkj_ecwo_ogp_ej_rnfkukf\" wt iq urtuwjm. Ocz iqa jdag vio uzthsivi pqx vkj pgyd encpggt. Uy hopg yjg fhkz arz hkscv ckoq pgfn vu wwygt nkioe zttft djkth.");
insert into level3sol values ("a", MD5("level3"));

insert into level4sol values("a", MD5("level4"));
